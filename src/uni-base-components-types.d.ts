...
declare module 'vue' {
  export interface GlobalComponents {
    'block': TBlock;
    'view': TView;
    'scroll-view': TScrollView;
    'match-media': TMatchMedia;
    'swiper': TSwiper;
    'swiper-item': TSwiperItem;
    'movable-view': TMovableView;
    'movable-area': TMovableArea;
    'text': TText;
    'rich-text': TRichText;
    'progress': TProgress;
    'button': TButton;
    'checkbox-group': TCheckboxGroup;
    'checkbox': TCheckbox;
    'form': TForm;
    'input': TInput;
    'label': TLabel;
    'picker': TPicker;
    'picker-view': TPickerView;
    'radio-group': TRadioGroup;
    'radio': TRadio;
    'slider': TSlider;
    'switch': TSwitch;
    'textarea': TTextarea;
    ...
    'canvas': TCanvas;
    'web-view': TWebView;
    'cover-view': TCoverView;
    'cover-image': TCoverImage;
    'icon': TIcon;
    'picker-view-column': TPickerViewColumn;
    'camera': TCamera;
    'live-player': TLivePlayer;
    'live-pusher': TLivePusher;
    'open-data': TOpenData;
    'ad': TAd;
    'ad-draw': TAdDraw;
    'navigation-bar': TNavigationBar;
    'custom-tab-bar': TCustomTabBar;
    'page-meta': TPageMeta;
    'editor': TEditor;
    'unicloud-db': TUnicloudDb;
  }
}
